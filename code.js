...
figma.ui.onmessage = (msg) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const cover = yield createCoverOnPage(page, msg, fontRegular, fontBold, grad);
        figma.currentPage.selection = [cover];
        figma.viewport.scrollAndZoomIntoView([cover]);
        try {
            yield figma.setFileThumbnailNodeAsync(cover);
        }
        catch (_b) {
        ...
        figma.notify(`Error: ${(err === null || err === void 0 ? void 0 : err.message) || err}`, { error: true });
    }
});
